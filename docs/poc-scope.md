...
- Local YAML build, security, DAST, deployment, verification, and release workflows
- Integration, regression, system, and performance extension points
- Automated repository provisioning and organization ruleset specifications
...
- Application workflows are local to the template; the central repository manages provisioning and organization governance.
- Python is the runnable sample; consumers replace the commands in `scripts/` for Java, .NET, JavaScript, MuleSoft, or other stacks.
